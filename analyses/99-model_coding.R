...
# Try reference coding (1 -1) feedback variable to compare with reference coded
# (0 1) in 04-model.R

df$feedback[df$feedback==0] <- -1
df$feedback <- as.factor(df$feedback) # without this step parameter estimates change
