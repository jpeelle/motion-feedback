# Does the same thing as 04_plot.R, but truncates data at 140 frames per session
# to avoid weird high values at the end of the run (for some people).
...
# get rid of the end of each run

df <- df[df$runframe<141,]
...
ggsave("figures/FDcomparison_140frames.png", width = 6, height = 4, units = "in", dpi = 300)
ggsave("figures/FDcomparison_140frames.pdf", width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("figures/FD_by_run_140frames.png", width = 6, height = 4, units = "in", dpi = 300)
ggsave("figures/FD_by_run_140frames.pdf", width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("figures/FDdensity_140frames.png", width = 6, height = 4, units = "in", dpi = 300)
ggsave("figures/FDdensity_140frames.pdf", width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("figures/DVARS_by_run_140frames.png", width = 6, height = 4, units = "in", dpi = 300)
ggsave("figures/DVARS_by_run_140frames.pdf", width = 6, height = 4, units = "in", dpi = 300)
